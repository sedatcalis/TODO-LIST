...
function App() {
  ...
  // api'ye gönderecegimiz parametreler
  ...
  // her sayfa degiştiginde günceller
  ...
  return (
     <div className="container p-5">
         ...
         <div className="d-flex justify-content-between my-5">
            <button disabled={page === 1} onClick={() => setPage(page - 1)} className="btn btn-primary">{`< GERİ`}</button>
            <span className="lead fw-bold">{page}</span>
            <button disabled={page == maxPage} onClick={() => setPage(page + 1)} className="btn btn-primary" >{`İLERİ >`}</button>
